...
class YelpDataset( Dataset ):
    ...
    def sampling( self ):
        ...
        self.train_x = torch.vstack( ( self.pos_train_interact, neg_idx ) )
        self.train_y = torch.vstack( ( 
            torch.ones( ( self.pos_train_interact.shape[0], 1 ) ),
            torch.zeros( ( neg_idx.shape[0], 1 ) )
        ) )
