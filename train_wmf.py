...
def construct_confidence_mat( dataset ):
    train_interact = dataset.pos_train_interact
...
def validate_model( model, dataset, csr_matrix, is_test=False ):
...
def train_model( config : dict, dataset ):
    ...
    validate_model( model, dataset, csr_matrix, is_test=False  )
